        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-3 px-4 pt-4 pb-3 flex-shrink-0">
                    <div
                        className="w-10 h-10 rounded-[12px] flex-shrink-0 grid place-items-center text-white"
        ...
        <div className="px-4 py-2.5 border-b border-slate-50 last:border-b-0">
            ...
            {options ? (
                <select
                    ...
                    className={`w-full text-[13px] font-semibold text-slate-900 bg-slate-50 border rounded-[10px] px-3 h-[38px] focus:outline-none focus:ring-2 transition ${error ? 'border-red-400 focus:ring-red-200' : 'border-slate-200 focus:ring-blue-200 focus:border-blue-400'}`}
                >
                ...
                <input
                    ...
                    className={`w-full text-[13px] font-semibold text-slate-900 bg-slate-50 border rounded-[10px] px-3 h-[38px] focus:outline-none focus:ring-2 transition placeholder:text-slate-300 ${error ? 'border-red-400 focus:ring-red-200' : 'border-slate-200 focus:ring-blue-200 focus:border-blue-400'}`}
                />
            )}
            ...
            <div className="w-full max-w-[430px] min-h-[100dvh] bg-slate-50 flex flex-col shadow-[0_0_0_1px_rgba(0,0,0,.04),0_8px_48px_rgba(0,0,0,.08)] relative overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto px-3 sm:px-[14px] pt-3 pb-[calc(100px+env(safe-area-inset-bottom))] flex flex-col gap-3">
                    ...
                    <div className="text-[11px] text-slate-300 text-center font-medium">
                        Anda Dapat Mengisi Secara Berkala. @2026 IKM Alora
                    </div>
                </div>
